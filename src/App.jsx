        ...
        {!pasteMode?(
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={"Paste your Excel PM table here...

Tip: Select all rows in Excel (including the header row) → Ctrl+C → click here → Ctrl+V"}
        ...
        <div>
          ...
          <div style={{background:"#fff",border:"1.5px solid #d8b4fe",borderRadius:10,padding:"14px",marginBottom:16}}>
            ...
            <textarea
              ...
              placeholder={"What happened today?\n\n• Units to watch tomorrow\n• Customers to follow up\n• Any issues or flags\n• Things the next shift needs to know"}
